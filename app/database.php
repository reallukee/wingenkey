<?php
  require_once __DIR__ . "/_controllers/database.php";  // Controller

  $title = "Database";                                  // Page Title
  $page = "DATABASE";                                   // Page Id
  ...
  $total = total($verifiedParam, $invalidatedParam, $versionParam, $editionParam, $typeParam);
