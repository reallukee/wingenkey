<?php
  ...
  $versions = versions($searchParam, $sortParam);
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Redirect
    header("location: ./versions.php?search=" . $_POST["search"] . "&sort=" . $_POST["sort"]);
  }
?>
            ...
            <div class="card-body">
              ...
              <div class="row g-3">
                ...
                <?php if ($MODE === "edit"): ?>
                  ...
                  <div class="col-auto">
                    <form action="./versions.php" method="post" class="mb-0">
...
<!--
  BEGIN CREATE MODAL
-->
<form action="./versions.php" method="post">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="text" class="form-control" name="name" id="name" placeholder="win11" />
          ...
          <input type="text" class="form-control" name="friendlyName" id="friendlyName" placeholder="Windows 11" />
        </div>
